...
\ref{tab:dual-cross-entropy-selection}. \JH{Add the data sizes after this
  cleaning step.}
...
initialization. \JH{Say more about the models.}
...
\JH{Paragraph about Tagged backtranslation. Refer to explanation in chapter
  2. \citep{caswell-etal-2019-tagged}}
