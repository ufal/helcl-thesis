...
\acs{wmt}~21 \JH{cite findings}. In this section, we present the results on
both datasets.
...
translation quality in all model variants. \JH{distill vs non-distill?}
...
\begin{figure}
  ...
  \begin{tabular}{lrrrrrrrr}
    ...
    Batch size & 1 & 2 & 4 & 8 & 16 & 32 & 64 & 128 \\
    \midrule
    \acs{ar} -- Large &&  & 19,001 & 13,586 & 10,939 & 9,651 & 9,124 & 9,067 \\
