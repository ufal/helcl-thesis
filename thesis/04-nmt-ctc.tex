...
\JH{Add a table with latencies on a GPU without minibatching.}
...
\begin{figure}
  \centering
  \resizebox{10cm}{7cm}{%
    \input{img/decoding_speed.tex}
  }

  \caption{Decoding speed \JH{todo: caption, rerender the image with better
      colors and scale}.}%
