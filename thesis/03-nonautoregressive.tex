...
``vielen dank'' and ``danke schĂśn.'' In this case, the pair of German tokens
``danke'' and ``vielen'' create the two modes on the first position, and the
tokens ``dank'' and ``schĂśn'' are modes on the second position. If an
...
two combinations, ``danke dank'' and ``vielen schĂśn''.
...
Instead of modelling fertility, the authors introduce $L$ discrete sequential
