...
\paragraph{Semi-Autoregressive \acs{nmt}} \citet{wang-etal-2018-semi}
...
\paragraph{Insertion Transformer.} \citet{stern-etal-2019-insertion}


\paragraph{KERMIT.} \citet{chan-etal-2019-kermit}
...
\paragraph{DisCO.} \citep{kasai2020nonautoregressive} -- NAR NMT with disentangled context transformer

\JH{these below} are considered fully NAT

\paragraph{DCRF} \citep{sun2019fast} -- fast structured decoding for sequence
models

\paragraph{Flowseq} \citep{ma-etal-2019-flowseq} -- NAR conditional sequence
generator with generative flow

\paragraph{EM+ODD} \citep{sun2020em} -- an em approach to NAR conditional seq
generation

\paragraph{GLAT} \citep{qian2020glancing} -- glancing transformer for NAR NMT
