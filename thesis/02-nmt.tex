...
referred to as \emph{sequence-to-sequence learning}. \JH{We explore the
  encoder-decoder architectures more closely in Sections ...}
...
\citep{jean-etal-2015-using}, in neural networks for \gls{nlp}, it is difficult
...
a vocabulary of a predefined size, such that nearly every word can be composed
...
The \ac{bpe} algorithm %(Algorithm ~\ref{alg:learn-bpe})
...
% - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
\paragraph{Wordpiece.}  \JH{describe this because we use this in the
  preliminary CTC experiments}
...
\citep{papineni-etal-2002-bleu}.  Despite a long term effort led by the organizers of
