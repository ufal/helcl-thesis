...
in a new paradigm of \emph{\acl{nmt}} (\acs{nmt}\glsunset{nmt}). Soon after
...
% \JH{advent of NMT methods, už to je hrozně dobrý a tak to všichni používaji}
% \JH{masový rozšiřování aplikací jak pro uživatele (low resource MT), různé
% domény, tak jednotlivý scénáře (computer aided tranlsation možá začíná dávat
% smysl)}

% \JH{rychle se vyvijejici vyzkum MT, objevuji se i zajimavy druhy NMT modelů a
%   taky se hodne rychle ujima v aplikacich.}
% \JH{spoustu zajímavých oborů jako třeba multimodální překlad, multi-source překlad, a taky non-autoregresivní překlad}
