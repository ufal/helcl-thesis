...
% \cvitem{2020}{Zdeněk Kasner, Jindřich Libovický, Jindřich Helcl, Ondřej Dušek:
%   Expand and Filter: CUNI and LMU systems for the WNGT 2020 Duolingo shared
%   task. In \emph{Proceedings of the Fourth Workshop on Natural Generation and
%     Translation (WNGT).}}

\cvitem{2020}{Zdeněk Kasner, Jindřich Libovický, Jindřich Helcl: Improving
  Fluency of Non-Autoregressive Neural Machine Translation. Published online.}
...
% \cvitem{2018}{Jindřich Helcl, Jindřich Libovický, Dušan Variš: CUNI System for
%   WMT18 Multimodal Tranlsation Task. In \emph{Proceedings of the Third
...
% \cvitem{2017}{Ondřej Bojar, Jindřich Helcl, Tom Kocmi, Jindřich Libovický,
%   Tomáš Musil: Results of the WMT17 Neural MT Training Task. In
%   \emph{Proceedings of the Second Conference on Machine Translation}}
...
% \cvitem{2016}{Eleftherios Avramidis, Vivien Macketanz, Aljoscha Burchardt,
%   Jindřich Helcl, Hans Uszkoreit: Deeper Machine Translation and Evaluation for
%   German. In \emph{Proceedings of the 2nd Deep Machine Translation Workshop}}

% \cvitem{2016}{Ondřej Bojar, Ondřej Cífka, Jindřich Helcl, Tom Kocmi, Roman
%   Sudarikov: UFAL Submissions to the IWSLT 2016 MT Track. In \emph{Proceedings
%     of the ninth International Workshop on Spoken Language Translation
%     (IWSLT)}}
